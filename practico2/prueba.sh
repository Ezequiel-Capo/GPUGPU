...
job_ej2=$(sbatch --parsable --output=ej2.out --error=ej2.err --open-mode=truncate lanzar.sh "./ej2" 32 0 0 18 20 10 4 8)
...
job_e3_2=$(sbatch --parsable --output=ej3_caso2.out --error=ej3_caso2.err --open-mode=truncate lanzar.sh "./ej3" 16384 16384 32 32)

job_e3_3=$(sbatch --parsable --output=ej3_caso3.out --error=ej3_caso3.err --open-mode=truncate lanzar.sh "./ej3" 16384 16384 4 64)
...
printf "E3-2) Prueba con tamaños Nx=16384, Ny=16384, blockDim=(32,32) para evaluar rendimiento\n"
cat ej3_caso2.out
printf "\n"

printf "E3-3) Prueba con tamaños Nx=16384, Ny=16384, blockDim=(4,64) para evaluar rendimiento\n"
cat ej3_caso3.out
printf "\n"